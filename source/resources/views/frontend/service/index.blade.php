...
<link rel="shortcut icon" href="frontend/images/favicon.ico?1521443544" type="image/x-icon" />
...
<link rel="icon" sizes="192x192" href="frontend/images/favicon.png?1521443544">

<!--CSS-->
<link href="frontend/css/bootstrap.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<link href="frontend/fonts/fontawesome/css/fontawesome.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<link href="frontend/fonts/fontawesome/css/fontawesome-all.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<link href="frontend/css/slick.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<link href="frontend/css/style.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<link href="frontend/css/responsive.css?1521443544" rel="stylesheet" type="text/css" media="all"/>
<!--[if lt IE 9]>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse main-nav">
        <ul class="nav navbar-nav fr">
          <li class="active"><a href="#">Giới thiệu<br> MAIA & MAIA</a></li>
          <li><a href="service.php">Thẩm mỹ <br>không phẫu thuật</a></li>
          <li><a href="#">Trẻ hóa <br>da mặt</a></li>
          <li><a href="#">Điều trị <br>& chăm sóc da</a></li>
          <li><a href="#">Kiến thức<br> Làm đẹp</a></li>
          <li><a href="#">Video <br>& Làm đẹp</a></li>
...
<a href="#">
  <img class="banner-images img-responsive" src="/banner/tu-tin-soi-guong.jpg" alt="" >
</a>
</banner>
  <main role="main">
    <div class="container">
      <div class="row">
        <div class="col-sm-9 left-col">
          ...
          <div class="booknow-wrapper">
            <button type="button" class="btn btn-primary rad0 btn-lg btn-block">Đặt lịch khám</button>
          </div>
        </div>
...
<script src="frontend/js/jquery.min.js?v=1521443544" type="text/javascript"></script>
<script src="frontend/js/bootstrap.min.js?v=1521443544" type="text/javascript"></script>
<script src="frontend/js/slick.min.js?v=1521443544" type="text/javascript"></script>
<script src="frontend/js/script.js?v=1521443544" type="text/javascript"></script>
