...
function CollectionController($scope, $http, $rootScope, $timeout) {
    ...
    $scope.edit = function (collection) {
        ...
        $http.get(url, {params: {api_token}}).success(function(response){
        ...
        $http({
            ...
            function(response){
                if (response.data.status == 'successful') {
                    showMessage('Created deal', 'The collection has been created!', 'success');
    ...
    $scope.updateCollection = function(){
      ...
      $http({
          ...
          function(response){
              ...
              if (response.data.status == 'successful') {
                  showMessage('Success', 'The collection has been updated', 'success');
                  $('#collectionForm').modal('hide');
                  $scope.resetForm();
                  $scope.find();
              } else {
