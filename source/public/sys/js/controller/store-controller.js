            ...
            data: data
                ...
                function (response) {
                    if (response.data.status == 'successful') {
                        showMessage(mode + ' store', 'The store has been ' + mode + 'd!', 'success');
                        $('#saveButton').button('reset');
        ...
        $http({
            ...
            data: $scope.editStore
                ...
                function (response) {
                    ...
                    if (response.data.status == 'successful') {
                        showMessage('Success', 'The store has been updated', 'success');
            ...
            data: $scope.deleteStore
                ...
                function (response) {
                    ...
                    if (response.data.status == 'successful') {
                        ...
                        showMessage('Success', 'The store has been deleted', 'success');
                    }
                },
                function error(response) {
                    showMessage('Can not send request!', 'Please contact technical team for support!', 'error');
