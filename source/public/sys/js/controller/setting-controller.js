...
function SettingController($scope, $http, $rootScope, $timeout, Upload) {
    ...
    $scope.delete = function (param) {
        ...
        $http.post(api_domain + "/api/setting/delete", {key: param.key, api_token: api_token}).success(function (data) {
    ...
    $scope.add = function () {
        ...
        $http.post(api_domain + "/api/setting/create", {param: $scope.newParam, api_token: api_token}).success(function (data) {
            if (data.status != 'successful') {
                showMessage("Error", data.message, "error");
            } else {
                ...
                $scope.newParam = {};
                showMessage("Successful", "Create param successful!", "success");
            }
            $('#addParamButton').button('reset');
        });
    };
