...
function DealController($scope, $http, $rootScope, $timeout, Upload) {
    ...
    $scope.upload = function (file, dealObj) {
        ...
        Upload.upload({
            ...
            $scope.onUploadNewDealLogoSuccess(resp, dealObj);
        }, function (resp) {
    ...
    $scope.onUploadNewDealLogoSuccess = function(resp, dealObj) {
        ...
        $http({
            ...
            function(response){
                if (response.data.status == 'successful') {
                    showMessage('Created deal', 'The deal has been created!', 'success');
                    $('#createDealButton').button('reset');
    ...
    $scope.updateDeal = function(){
        ...
        $http({
            ...
            function(response){
                ...
                if (response.data.status == 'successful') {
                    showMessage('Success', 'The deal has been updated', 'success');
        ...
        $http({
            ...
            function(response){
                ...
                if (response.data.status == 'successful') {
                    ...
                    showMessage('Success', 'The deal has been deleted', 'success');
                }
            },
            function error(response){
                showMessage('Can not send request!', 'Please contact technical team for support!', 'error');
    ...
    $scope.saveSortOrders = function (items) {
        ...
        $http.post(api_domain + "/api/deal/update-multi-order", param).success(function (data) {
