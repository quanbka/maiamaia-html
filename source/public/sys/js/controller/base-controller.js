...
//        result += ", " + (seconds < 10 ? "0" + seconds + " giây" : seconds + " giây");
    ...
    this.initTinymce = function (selector, height, readonly,callBackFn) {
        ...
        tinymce.init({
            ...
            toolbar: "fontselect | fontsizeselect | styleselect | bold italic underline | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | imageupload | media",
